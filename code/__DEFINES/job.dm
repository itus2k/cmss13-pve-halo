...
#define SQUAD_MARINE_2 "Rock Hoppers Sq. 2"
...
#define JOB_INSURGENT_CELL_LEAD "Insurgent Cell Leader"

#define INSURGENT_JOB_LIST list(JOB_INSURGENT_PARTISAN, JOB_INSURGENT_PARTISAN_BREACH, JOB_INSURGENT, JOB_INSURGENT_TECHNICIAN, JOB_INSURGENT_SPECIALIST, JOB_INSURGENT_SL, JOB_INSURGENT_LEAD, JOB_INSURGENT_CELL_LEAD)
...
#define UNSC_CREW_JOB_LIST list(JOB_UNSC_CREW, JOB_UNSC_CREW_FLIGHT, JOB_UNSC_CREW_FLIGHT_CHIEF, JOB_UNSC_CREW_ENGI, JOB_UNSC_CREW_ENGI_CHIEF, JOB_UNSC_CREW_MED, JOB_UNSC_CREW_MED_CHIEF, JOB_UNSC_CREW_OPS, JOB_UNSC_CREW_OPS_CHIEF, JOB_UNSC_CREW_RND, JOB_UNSC_CREW_COM, JOB_UNSC_CREW_COM_XO, JOB_UNSC_CREW_COM_CPT)
//--------------------//
