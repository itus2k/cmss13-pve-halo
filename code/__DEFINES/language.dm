...
#define ALL_HUMAN_LANGUAGES list(LANGUAGE_ENGLISH, LANGUAGE_JAPANESE, LANGUAGE_CHINESE, LANGUAGE_RUSSIAN, LANGUAGE_GERMAN, LANGUAGE_SPANISH, LANGUAGE_PORTUGUESE, LANGUAGE_FRENCH, LANGUAGE_FILIPINO, LANGUAGE_PORTUGUESE, LANGUAGE_FRENCH, LANGUAGE_FILIPINO, LANGUAGE_RUSPATOIS, LANGUAGE_POLISH)
