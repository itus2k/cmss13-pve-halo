...
#define PO3_VARIANT "Petty Officer 3rd Class"
#define PO2_VARIANT "Petty Officer 2nd Class"
...
/datum/job/marine/medic
	...
	job_options = list(PO2_VARIANT = "PO2", PO3_VARIANT = "PO3")
