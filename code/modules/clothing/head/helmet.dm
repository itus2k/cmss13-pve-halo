...
/obj/item/clothing/head/helmet/marine/unsc/motion
	...
	desc = "An upgraded helmet of the UNSC Marine Corps, with a motion tracker. Various attachment points on the helmet allow for various equipment to be fitted to the helmet."
	motion_tracker = TRUE
