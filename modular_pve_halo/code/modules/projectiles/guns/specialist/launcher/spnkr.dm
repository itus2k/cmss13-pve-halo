...
/obj/item/weapon/gun/halo_launcher/spnkr/use_unique_action()
	...
	message_admins(FONT_SIZE_XL("<A href='byond://?_src_=admin_holder;[HrefToken(forceGlobal = TRUE)];adminacceptspnkr=1;spnkr=\ref[src];turf=\ref[sound_turf];missile_name=\ref[missile_name]'>CLICK TO SUCCEED/FAIL MISSILE LAUNCH</a>"))
